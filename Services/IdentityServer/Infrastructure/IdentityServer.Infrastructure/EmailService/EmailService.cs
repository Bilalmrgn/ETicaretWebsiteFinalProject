...
namespace IdentityServer.Infrastructure.EmailService
{
    public class EmailService : IEmailService
    {
        ...
        public async Task SendEmailConfirmationEmail(string link, string toEmail)
        {
            ...
            var mailMessage = new MailMessage
            {
                ...
                Body = $@"
        <h4>Email adresinizi değiştirmek için aşağıdaki linke tıklayın</h4>
        <p><a href='{link}'>Emaili Onayla</a></p>",
                IsBodyHtml = true
            };
